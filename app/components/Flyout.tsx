...
function Flyout({
  ...
  isRowEnd = false,
  isOpen = false,
  notificationItems = [], // [{ title: "No items found" }],

  items = [
    // <div>flyout child lyout child lyout child 1</div>,
    // <div>flyout child 2</div>,
    // <div>flyout child 3</div>,
  ],
  ...
  return (
    <div className={`altd-flyout space-y-12 ${controllingComponent.length > 0 ? "relative" : ""}`}>
